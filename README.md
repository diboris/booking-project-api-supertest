# JS REST API tests [![Build Actions Status](https://github.com/diboris/booking-project-api-supertest/actions/workflows/actions.yml/badge.svg)](https://github.com/diboris/js-restapi-tests/actions)
